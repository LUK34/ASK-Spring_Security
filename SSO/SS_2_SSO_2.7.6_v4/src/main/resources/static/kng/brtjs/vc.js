// -----------------------------
// VISIT COUNT REPORT
// FORM SUBMIT LOGIC (IE11 SAFE)
// -----------------------------

document.addEventListener('DOMContentLoaded', function () 
{

    var form = document.getElementById('vc');
    if (!form) 
    {
        return;
    }
    ...
    form.addEventListener('submit', function (e) 
    {
        ...
        var sdateEl = document.getElementById('sdate13');
        var edateEl = document.getElementById('edate13');
        var error   = document.getElementById('vc-error-message');
