document.addEventListener('DOMContentLoaded', function () 
{
    ...
    var form = document.getElementById('phavoscf');
    if (!form)
    {
        return;
    }
    ...
    form.addEventListener('submit', function (e) 
    {
        ...
        var sdateEl = document.getElementById('sdate15');
        var edateEl = document.getElementById('edate15');
        var error   = document.getElementById('phavoscf-error-message');
